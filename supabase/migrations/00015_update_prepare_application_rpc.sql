-- ==============================================================================
-- Migration: 00015_update_prepare_application_rpc.sql
-- Description: Updates prepare_application stored function to handle 1-to-1 application
--              uniqueness constraint (uq_applications_user_job) seamlessly across concurrent preparations.
-- ==============================================================================
